    ...
    <section id="hero" class="s-hero">
                    ...
                    <div class="column">
                        <div class="s-hero__slide-meta">
                            ...
                            <span class="byline"> 
                                Опубликовано 
                                <span class="author">
                                    <a href="profile.html">Джонатан Доу</a>
                                </span>
                            </span>
                        </div>
                        <h1 class="s-hero__slide-text">
                            <a href="#0">
                                Советы и идеи, которые помогут Вам начать фриланс.
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <div class="s-hero__slide">
                ...
                <div class="row s-hero__slide-content animate-this">
                    <div class="column">
                        ...
                        <h1 class="s-hero__slide-text">
                            <a href="#0">
                                Минимализм: Искусство держать Его простым.
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <div class="s-hero__slide">
                ...
                <div class="row s-hero__slide-content animate-this">
                    <div class="column">
                        ...
                        <h1 class="s-hero__slide-text">
                            <a href="#0">
                                10 Причин, По которым пребывание на природе полезно для вас.
                            </a>
                        </h1>
                    </div>
                </div>
        ...
        <div class="s-hero__social hide-on-mobile-small">
            ...
            <ul class="s-hero__social-icons">
                ...
                <li><a href="https://www.pinterest.ru/"><i class="fab fa-pinterest" aria-hidden="true"></i></a></li>
            </ul>
            ...
            <div class="masonry">
                <div class="bricks-wrapper h-group">
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="https://www.dreamhost.com/r.cgi?287326">Нужен Веб-хостинг для ваших сайтов?</a></h1>
                            ...
                            <div class="entry__excerpt">
                                <p>
                                Нужен хостинг? Мы высоко рекомендуем хостинг DreamHost.
                            ...
                            <a class="entry__more-link" href="https://www.dreamhost.com/r.cgi?287326">Узнать больше</a>
                        </div> <!-- end entry__text -->
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">Обычный Простой Пост В Блоге.</a></h1>
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">10 Интересных Фактов О Кофеине.</a></h1>
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">5 Методов Окраски в Оттенках Серого.</a></h1>
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">Использование повторений и паттернов в фотографии.</a></h1>
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">Создание Семейных Значимых Моментов.</a></h1>
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">То, Как Мы Живем, Делает Нас Реальными.</a></h1>
                    ...
                    <article class="brick entry" data-aos="fade-up">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                <h1 class="entry__title"><a href="single-standard.php">Симметрия В Современном Дизайне.</a></h1>
