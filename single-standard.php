        ...
        <div class="row s-header__navigation">
            ...
            <nav class="s-header__nav-wrap">
                ...
                <ul class="s-header__nav">
                    ...
                    <li><a href="styles.html" title="styles.html">Стили</a></li>
                    <li><a href="about.php" title="about.php">О нас</a></li>
                    <li class="current"><a href="contact.php" title="">Контакты</a></li>
            ...
            <div class="s-header__search-inner">
                <div class="row wide">
                    ...
                    <form role="search" method="get" class="s-header__search-form" action="#">
                        <label>
                            <span class="h-screen-reader-text">Искать по:</span>
            ...
            <div class="column large-12">
                ...
                <article class="s-content__entry format-standard">
                    ...
                    <div class="s-content__entry-header">
                        <h1 class="s-content__title s-content__title--post">Это стандартный форматный пост профиля.</h1>
                    ...
                    <div class="s-content__primary">
                        ...
                        <div class="s-content__entry-content">
                            ...
                            <p>
                                <img src="images/Clutch - Book of Bad Decisions.png" 
        ...
        border-radius: 3px;
                        ...
                        <div class="s-content__entry-meta">
                            ...
                            <div class="entry-author meta-blk">
                                ...
                                <div class="byline">
                                    <span class="bytext">Опубликовано</span>
                                    <a href="profile.html">Джон Доу</a>
                                </div>
                            </div>
        ...
        <div class="comments-wrap">
                    ...
                    <ol class="commentlist">
                        ...
                        <li class="thread-alt depth-1 comment">
                            ...
                            <div class="comment__content">
                                ...
                                <div class="comment__info">
                                    <div class="comment__author">Джон Доу</div>
            ...
            <div class="row comment-respond">
                ...
                <div id="respond" class="column">
                    ...
                    <h3>
                    Добавьте коммент
                    <span>Ваш адрес email не будет опубликован.</span>
                    </h3>

                    <form name="contactForm" id="contactForm" method="post" action="/mail.php" autocomplete="off">
                        <fieldset>

                            <div class="form-field">
                                <input name="name" id="name" class="h-full-width h-remove-bottom" placeholder="Ваше имя"  type="text">
                            </div>

                            <div class="form-field">
                                <input name="email" id="email" class="h-full-width h-remove-bottom" placeholder="Ваш Email" type="text">
                            </div>

                            <div class="form-field">
                                <input name="header" id="header" class="h-full-width h-remove-bottom" placeholder="Website" type="text">
                            </div>

                            <div class="message form-field">
                                <textarea name="message" id="message" class="h-full-width" placeholder="Ваше сообщение"></textarea>
                            </div>
